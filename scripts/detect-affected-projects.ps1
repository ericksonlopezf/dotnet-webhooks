...
$packageMap = [ordered]@{
    "Core" = @{
        patterns = @("src/EricksonLopez.Webhooks/", "tests/EricksonLopez.Webhooks.Tests/")
        config = "stryker-config.json"
        outputDir = "StrykerOutput/core"
        artifact = "stryker-report-core"
    }
    "AspNetCore" = @{
        patterns = @("src/EricksonLopez.Webhooks.AspNetCore/", "tests/EricksonLopez.Webhooks.AspNetCore.Tests/")
        config = "stryker-aspnetcore-config.json"
        outputDir = "StrykerOutput/aspnetcore"
        artifact = "stryker-report-aspnetcore"
    }
    "Redis" = @{
        patterns = @("src/EricksonLopez.Webhooks.Redis/", "tests/EricksonLopez.Webhooks.Redis.Tests/")
...
$globalTriggers = @("Directory.Build.props", "Directory.Packages.props", "EricksonLopez.Webhooks.slnx", ".editorconfig")
